...
public class HotOrNot  {
    ...
    public void upateEntry(long lRow, String mName, String mHotness) throws SQLException{
    ...
    public String getData() {
        ...
        int iHotess = c.getColumnIndex(KEY_HOTNESS);

        for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
            result = result + c.getString(iRow) + " " + c.getString(iName) + " " + c.getString(iHotess) + " \n";
        }
        return result;
    }
