...
public class Email extends Activity implements View.OnClickListener {
    ...
    private void initializeVars() {
        // TODO Auto-generated method stub
        personsEmail = (EditText) findViewById(R.id.et_emailAddress);
        intro = (EditText) findViewById(R.id.et_emailTitle);
        personsName = (EditText) findViewById(R.id.et_personsName);
        stupidThings = (EditText) findViewById(R.id.et_emailBody);
        hatefulAction = (EditText) findViewById(R.id.et_companyDisclaimer);
        outro = (EditText) findViewById(R.id.et_legalStuff);
